...
# Commented out in favour of Interactive Graph (interactive_graph.py).
# The node functions above (triage_source, resolve_categories, etc.)
# are kept for reference and for the interactive_start endpoint
# which still calls triage_source for initial file profiling.
#
...
# graph = builder.compile(checkpointer=checkpointer, interrupt_after=["evaluate"])
...
#     ...  # identical logic lives in interactive_graph.py:render_interactive
#     return state
#
...
#     checkpointer=checkpointer, interrupt_after=["human_input"],
# )
